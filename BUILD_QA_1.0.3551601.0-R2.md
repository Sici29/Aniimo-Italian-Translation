...
- Suite test PyUnit: 133 test superati su 133 (0 fallimenti, 0 errori).
...
- Diagnostica standalone: rilevamento automatico Steam (`steamapps\common\Aniimo`), compatibilità 100% verde confermata e `loose_i18n_in_sync = True`.
